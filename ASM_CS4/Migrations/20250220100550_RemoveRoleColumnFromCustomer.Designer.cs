...
namespace ASM_CS4.Migrations
{
    ...
    [Migration("20250220100550_RemoveRoleColumnFromCustomer")]
    partial class RemoveRoleColumnFromCustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASM_CS4.Models.Cart", b =>
                {
                    ...
                    b.Property<string>("ProductMaSanPham")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ASM_CS4.Models.Cart", b =>
                {
                    ...
                    b.HasOne("ASM_CS4.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductMaSanPham")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
